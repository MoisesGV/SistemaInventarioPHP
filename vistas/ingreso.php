                      ...
                      <div class="panel-body" style="height: 400px;" 
                          ...
                          <form name="formulario"
                              ...
                              <div class="col-md-12 col-xm-12">
                                <table id="detalleIngreso" class="table table-striped table-bordered table-condensed table-hover">
                                  ...
                                  <tfoot>
                                    ...
                                    <th></th>
                                    <th></th>
                                    <th><h4 id="total">00.0</h4><input type="hidden" name="total_compra" id="total_compra"></th>
                                  </tfoot>
